...
> Create measurable savings and capability inside **Microsoft 365 E3**, using **file exports only**, with a **human in control of every financial and customer-facing decision**.
...
- A working Power BI Desktop pilot on the Export Layer.
- A PDF/email order-intake agent that drafts orders for human approval.
- A bank-reconciliation assistant that proposes matches for the finance controller.
- A live Business Glossary and Opportunity Catalogue.

---

## Governance & privacy

- Financial, pricing and customer-facing outputs always require human approval.
- Data classified and handled in line with GDPR.
- No live ERP connectors without an evidence-backed business case.

---

## Next step

Introductory call: confirm scope, dependencies, steering committee sponsor and BICC counterpart; agree Phase 0 kick-off date.
